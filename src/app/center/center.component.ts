...
export class CenterComponent implements OnInit {
  ...
  list = Item[Item.length] = [
    ...
    new Item('USB Disk 3.5 inch external',
      ...
      '',
      ''),
    new Item('USB 3.0 Type-C OTG USB (two ports) Flash Drive 32 GB Pen Drive USB Key for Android/PC',
      '32 GB OF MOVIES!',
      'http://www.aliexpress.com/item/USB-3-0-Type-C-OTG-USB-Flash-Drive-128gb-64gb-Pendrive-32gb-16gb-pendrive-8gb/32926000099.html',
      'https://bit.ly/2K0cYxc'),
